...
<!-- 下载量 & 版本 -->
<div>
  <a href="https://pepy.tech/project/sahi"><img src="https://pepy.tech/badge/sahi" alt="总下载量"></a>
...
| 命令                                                                                                  | 描述                                                                                                                                                                                                                                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [predict](https://github.com/obss/sahi/blob/main/docs/cli.md#predict-command-usage)                   | 使用任意 [ultralytics](https://github.com/ultralytics/ultralytics) / [mmdet](https://github.com/open-mmlab/mmdetection) / [huggingface](https://huggingface.co/models?pipeline_tag=object-detection&sort=downloads) / [torchvision](https://pytorch.org/vision/stable/models.html#object-detection) 模型进行切片或标准视频/图像预测 -- 参见 [CLI 指南](cli.md) |
...
| 资源                                                                                                                                                | 类型     |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| [SAHI 简介](https://medium.com/codable/sahi-a-vision-library-for-performing-sliced-inference-on-large-images-small-objects-c8b086af3b80)            | 博客文章 |
| [视频教程（2025年）](https://www.youtube.com/watch?v=ILqMBah5ZvI) ⭐                                                                                 | 视频     |
| [官方论文](https://ieeexplore.ieee.org/document/9897990) (ICIP 2022 oral)                                                                           | 论文     |
| [预训练权重 和 ICIP 2022 论文文件](https://github.com/fcakyon/small-object-detection-benchmark)                                                      | 基准测试 |
| [使用 FiftyOne 可视化并评估 SAHI 的预测结果](https://voxel51.com/blog/how-to-detect-small-objects/)                                                 | 博客文章 |
| [《探索 SAHI》-- learnopencv.com](https://learnopencv.com/slicing-aided-hyper-inference/)                                                           | 文章     |
| [Encord 对 Slicing Aided Hyper Inference（SAHI）的解读](https://encord.com/blog/slicing-aided-hyper-inference-explained/)                            | 文章     |
| [视频教程：SAHI 在小目标检测中的应用](https://www.youtube.com/watch?v=UuOJKxn-M8&t=270s)                                                             | 视频     |
| [卫星图像目标检测](https://blog.ml6.eu/how-to-detect-small-objects-in-very-large-images-70234bab0f98)                                                | 博客文章 |
| [COCO 数据集转换](https://medium.com/codable/convert-any-dataset-to-coco-object-detection-format-with-sahi-95349e1fe2b7)                             | 博客文章 |
...
请在 [CLI 文档](cli.md) 中查找关于使用 `sahi predict`

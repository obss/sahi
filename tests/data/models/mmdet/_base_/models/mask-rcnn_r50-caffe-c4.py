"""MMDetection configuration file for mask-rcnn_r50-caffe-c4.py."""
...
model = dict(
    ...
    roi_head=dict(
        ...
        shared_head=dict(
            type="ResLayer", depth=50, stage=3, stride=2, dilation=1, style="caffe", norm_cfg=norm_cfg, norm_eval=True
        ),

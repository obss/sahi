...
try:
    from transformers import AutoModelForUniversalSegmentation, OneFormerProcessor
except ImportError:
...
def test_load_model() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType) -> None:
        """Test loading a HuggingFace oneformer univeral segmentation model."""
        huggingface_segmentation_model = HuggingFaceUniversalSegmentationModel(
            model_path=HuggingfaceConstants.ONEFORMER_MODEL_PATH,
            device=MODEL_DEVICE,
...
def test_set_model() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType) -> None:
        """Test setting a pre-loaded HuggingFace oneformer univeral segmentation model."""
        assert AutoModelForUniversalSegmentation
        assert OneFormerProcessor

        huggingface_model = AutoModelForUniversalSegmentation.from_pretrained(HuggingfaceConstants.ONEFORMER_MODEL_PATH)
        huggingface_processor = OneFormerProcessor.from_pretrained(HuggingfaceConstants.ONEFORMER_MODEL_PATH)
...
def test_pre_process_handler() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType) -> None:
        """Test sliced prediction with HuggingFace oneformer univeral segmentation model."""
        assert AutoModelForUniversalSegmentation is not None and OneFormerProcessor is not None
...
def test_post_process_handler() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType) -> None:
        """Test inference with HuggingFace oneformer univeral segmentation model."""
        assert AutoModelForUniversalSegmentation is not None and OneFormerProcessor is not None
...
def test_get_prediction_huggingface() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType) -> None:
        """Test full-image prediction with HuggingFace oneformer univeral segmentation model."""
        assert AutoModelForUniversalSegmentation is not None and OneFormerProcessor is not None

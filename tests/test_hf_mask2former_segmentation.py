...
def test_load_model() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType, model_path: str) -> None:
        """Test loading a HuggingFace mask2former univeral segmentation model."""
...
def test_set_model() -> None:
    def test_by_segmentation_type(segmentation_type: SegmentationType, model_path: str) -> None:
        ...
        huggingface_model = AutoModelForUniversalSegmentation.from_pretrained(model_path)
        huggingface_processor = Mask2FormerImageProcessor.from_pretrained(model_path)
